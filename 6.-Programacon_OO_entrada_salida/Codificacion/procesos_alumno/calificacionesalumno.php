		  ...
		  <ul class="navbar-nav">
		    <li class="nav-item active">
		      <a class="nav-link" href="datosalumno.php">Datos personales</a>
		   	<li class="nav-item active">
		      <a class="nav-link" href="comentarioalumno.php">Comentarios</a>
		   	<li class="nav-item active">
...
$sql="select id_grupo from alumno where id_alumno=$usuario";
$tab=mysqli_query($conexion,$sql);
$reg=mysqli_fetch_assoc($tab);
$grado=$reg["id_grupo"];

$sql="select alumno_asignatura.*, asignatura.nombre, asignatura.id_grupo 
			 from alumno_asignatura 
			 inner join asignatura on alumno_asignatura.id_asignatura=asignatura.id_asignatura 
			 where alumno_asignatura.id_alumno = $usuario and asignatura.id_grupo = $grado";
